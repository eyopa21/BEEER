                    ...
                    <div class="w-full max-w-full px-3 mx-auto mt-4 sm:my-auto sm:mr-0 md:w-1/2 md:flex-none lg:w-4/12">
                        <div class="relative right-0">
                            <ul class="relative flex flex-wrap p-1 list-none bg-transparent rounded-xl flex-col on-resize"
                                ...
                                <div class="z-10 absolute text-slate-700 rounded-lg bg-inherit flex-auto text-center bg-none border-0 block"
                                    moving-tab="" nav-link=""
                                    style="box-shadow: rgb(221, 221, 221) 0px 1px 5px 1px; padding: 0px; transition: all 0.5s ease 0s; transform: translate3d(0px, 0px, 0px); width: 28px;">
                                    <a class="z-30 block w-full px-0 py-1 mb-0 transition-all border-0 rounded-lg ease-soft-in-out text-slate-700 bg-white text-white shadow-soft-xxs"
                                        nav-link="" active="" href="javascript:;" role="tab" aria-selected="true"
                                        style="animation: 0.2s ease 0s 1 normal none running none;">-</a>
                                </div>
                            </ul>
                        </div>
                    </div>
...
<label for=" follow" class="w-4/5 mb-0 ml-4 overflow-hidden font-normal cursor-pointer select-none text-sm text-ellipsis whitespace-nowrap text-slate-500">Email
                            ...
                            <div class="flex flex-wrap -mx-3">
                                ...
                                <div class="w-full max-w-full px-3 text-right shrink-0 md:w-4/12 md:flex-none">
                                    ...
                                    <div data-target="tooltip"
                                        ...
                                        role="tooltip"
                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(332px, 368.667px, 0px);"
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div data-target="tooltip"
                                                        ...
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(288px, 1671.33px, 0px);"
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(300.667px, 1671.33px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Ryan Milly
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(312.667px, 1671.33px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Nick Daniel
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(324.667px, 1671.33px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Peterson
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(288px, 2058px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Nick Daniel
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(300.667px, 2058px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Peterson
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(312.667px, 2058px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Elena Morison
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(324.667px, 2058px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Ryan Milly
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(288px, 2444px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Peterson
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(300.667px, 2444px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Nick Daniel
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(312.667px, 2444px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Ryan Milly
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                                    ...
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm"
                                                        role="tooltip"
                                                        style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(324.667px, 2444px, 0px);"
                                                        data-popper-placement="top" data-popper-reference-hidden=""
                                                        data-popper-escaped="">
                                                        Elena Morison
                                                        <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"

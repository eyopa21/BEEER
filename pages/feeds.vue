...
import { GetBlogs } from '../queries/blogs/get.gql'
import { parseMarkdown } from '~/utils/parseMarkdown'
const { onResult, onError, loading, refetch } = useQuery(GetBlogs)
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center mr-auto">
                                                ...
                                                <div class="flex flex-col ml-3">
                                                    <div class="font-medium leading-none text-black dark:text-gray-100">
                                                        Eyob
                                                        Nigussie</div>

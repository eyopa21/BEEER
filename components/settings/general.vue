        ...
        <UForm :schema="GeneralValidationSchema" :state="State" @submit="UPDATE">
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-12 sm:col-span-3">
                    ...
                    <UFormGroup name="profession" v-slot="{ error }" label="Current profession"
                        :eager-validation="true">
                        <UInput v-model="State.profession" type="text" placeholder="Your current profession..."
                            size="lg"
                            :trailing-icon="error ? 'i-heroicons-exclamation-triangle-20-solid' : undefined" />
                    </UFormGroup>
                </div>
                ...
                <div class="col-span-12 sm:col-span-3">
                    ...
                    <UFormGroup name="work_place" v-slot="{ error }" label="Work place" :eager-validation="true">
                        <UInput v-model="State.work_place" type="text" placeholder="Your current work place..."
                            size="lg"
                            :trailing-icon="error ? 'i-heroicons-exclamation-triangle-20-solid' : undefined" />
                    </UFormGroup>
                </div>
                <div class="col-span-12 sm:col-span-6">
                    <UFormGroup name="bio" v-slot="{ error }" label="Bio" :eager-validation="true">
                        <UTextarea v-model="State.bio" type="text" placeholder="Description about your self..."
                            size="lg"
                            :trailing-icon="error ? 'i-heroicons-exclamation-triangle-20-solid' : undefined" />
                    </UFormGroup>
                </div>
